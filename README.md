...
| 2026-07 | Dango | **Critical** | Perps closed-session order-book index-price manipulation drains vault and depositor funds | [CVE-2026-86048](https://github.com/left-curve/left-curve/security/advisories/GHSA-mrmp-9x6x-r6p8) |
...
| 2026-05 | Trezor | **High** | Solana stake-claim shows only the aggregate `lamports` total: attacker diverts most of the withdrawal unseen | [advisory](https://trezor.io/vulnerability/solana-stake-claim-recipient-amount-display) |
