...
| 2026-05 | Trezor | **High** | Solana stake-claim batch shows only the aggregate `lamports` total, and the per-recipient warnings carry no amount: attacker redirects most of the withdrawal while the displayed total stays correct | [advisory](https://trezor.io/vulnerability/solana-stake-claim-recipient-amount-display) |
